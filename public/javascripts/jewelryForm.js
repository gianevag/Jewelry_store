$(document).ready(function() {
        ...
        $('#jewelryForm').submit(function(event) {
            ...
            formData.append('gold_metal_price', JSON.stringify({
                price_9K : $('#gold_priceK9').text(),
                price_14K : $('#gold_priceK14').text(),
                price_18K : $('#gold_priceK18').text(),                
            }) )
            
            console.log(formData.get('gold_metal_price'));                 
            // process the form
            $.ajax({
